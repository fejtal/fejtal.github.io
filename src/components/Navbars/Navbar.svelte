<script>
import MiniCart from "../Dropdowns/MiniCart.svelte";
  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        <li><a href= "wikipedia.org">Item 1</a></li>
        <li tabindex="0">
          <a href= "wikipedia.org" class="justify-between">
            Parent
        ...
        <li><a href= "wikipedia.org">Item 3</a></li>
      </ul>
    </div>
    <a href= "wikipedia.org" class="btn btn-ghost normal-case text-xl">TEST</a>
  </div>
