    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span1, file$b, 10, 10, 761);
    			attr_dev(span2, "class", "text-info");
    			add_location(span2, file$b, 11, 10, 819);
    			attr_dev(button, "class", "btn btn-primary btn-block");
    			add_location(button, file$b, 13, 12, 916);
    			attr_dev(div1, "class", "card-actions");
    			add_location(div1, file$b, 12, 10, 876);
    			attr_dev(div2, "class", "card-body");
    			add_location(div2, file$b, 9, 8, 726);
    			attr_dev(div3, "tabindex", "0");
    			attr_dev(div3, "class", "mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow");
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$a, 10, 10, 475);
    			attr_dev(a0, "href", "https://google.com");
    			attr_dev(a0, "class", "justify-between");
    			add_location(a0, file$a, 8, 8, 391);
    			add_location(li0, file$a, 7, 6, 377);
    			attr_dev(a1, "href", "https://google.com");
    			add_location(a1, file$a, 13, 10, 544);
    			add_location(li1, file$a, 13, 6, 540);
    			attr_dev(a2, "href", "https://google.com");
    			add_location(a2, file$a, 14, 10, 602);
    			add_location(li2, file$a, 14, 6, 598);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$9, 9, 118, 433);
    			attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg0, "class", "h-5 w-5");
    			attr_dev(svg0, "fill", "none");
    			attr_dev(svg0, "viewBox", "0 0 24 24");
    			attr_dev(svg0, "stroke", "currentColor");
    			add_location(svg0, file$9, 9, 8, 323);
    			attr_dev(label, "for", "navbar");
    			attr_dev(label, "tabindex", "0");
    			attr_dev(label, "class", "btn btn-ghost lg:hidden");
    			add_location(label, file$9, 8, 6, 248);
    			attr_dev(a0, "href", "wikipedia.org");
    			add_location(a0, file$9, 12, 12, 681);
    			add_location(li0, file$9, 12, 8, 677);
    			attr_dev(path1, "d", "M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z");
    			add_location(path1, file$9, 16, 116, 947);
    			attr_dev(svg1, "class", "fill-current");
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "width", "24");
    			attr_dev(svg1, "height", "24");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			add_location(svg1, file$9, 16, 12, 843);
    			attr_dev(a1, "href", "wikipedia.org");
    			attr_dev(a1, "class", "justify-between");
    			add_location(a1, file$9, 14, 10, 760);
    			attr_dev(a2, "href", "wikipedia.org");
    			add_location(a2, file$9, 19, 16, 1086);
    			add_location(li1, file$9, 19, 12, 1082);
    			attr_dev(a3, "href", "wikipedia.org");
    			add_location(a3, file$9, 20, 16, 1147);
    			add_location(li2, file$9, 20, 12, 1143);
    			attr_dev(ul0, "class", "p-2");
    			add_location(ul0, file$9, 18, 10, 1052);
    			attr_dev(li3, "tabindex", "0");
    			add_location(li3, file$9, 13, 8, 731);
    			attr_dev(a4, "href", "wikipedia.org");
    			add_location(a4, file$9, 23, 12, 1236);
    			add_location(li4, file$9, 23, 8, 1232);
    			...
    			add_location(ul1, file$9, 11, 6, 562);
    			attr_dev(div0, "class", "dropdown");
    			add_location(div0, file$9, 7, 4, 218);
    			attr_dev(a5, "href", "wikipedia.org");
    			attr_dev(a5, "class", "btn btn-ghost normal-case text-xl");
    			add_location(a5, file$9, 26, 4, 1307);
    			attr_dev(div1, "class", "navbar-start");
    			add_location(div1, file$9, 6, 2, 186);
    			attr_dev(a6, "href", "wikipedia.org");
    			add_location(a6, file$9, 30, 10, 1493);
    			add_location(li5, file$9, 30, 6, 1489);
    			attr_dev(path2, "d", "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z");
    			add_location(path2, file$9, 34, 114, 1727);
    			attr_dev(svg2, "class", "fill-current");
    			attr_dev(svg2, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg2, "width", "20");
    			attr_dev(svg2, "height", "20");
    			attr_dev(svg2, "viewBox", "0 0 24 24");
    			add_location(svg2, file$9, 34, 10, 1623);
    			attr_dev(a7, "href", "wikipedia.org");
    			add_location(a7, file$9, 32, 8, 1568);
    			attr_dev(a8, "href", "wikipedia.org");
    			add_location(a8, file$9, 37, 14, 1859);
    			add_location(li6, file$9, 37, 10, 1855);
    			attr_dev(a9, "href", "wikipedia.org");
    			add_location(a9, file$9, 38, 14, 1918);
    			add_location(li7, file$9, 38, 10, 1914);
    			attr_dev(ul2, "class", "p-2");
    			add_location(ul2, file$9, 36, 8, 1827);
    			attr_dev(li8, "tabindex", "0");
    			add_location(li8, file$9, 31, 6, 1541);
    			attr_dev(a10, "href", "wikipedia.org");
    			add_location(a10, file$9, 41, 10, 2001);
    			add_location(li9, file$9, 41, 6, 1997);
    			attr_dev(ul3, "class", "menu menu-horizontal p-0");
    			add_location(ul3, file$9, 29, 4, 1444);
    			attr_dev(div2, "class", "navbar-center hidden lg:flex");
    			add_location(div2, file$9, 28, 2, 1396);
    			attr_dev(div3, "class", "navbar-end");
    			add_location(div3, file$9, 44, 2, 2066);
    			attr_dev(div4, "class", "navbar rounded-md bg-base-200");
